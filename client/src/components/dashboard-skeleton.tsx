export function StatCardSkeleton() {
  return (
    <div className="rounded-lg p-4 border bg-gray-50 border-gray-100 animate-pulse">
      <div className="flex items-center gap-2 mb-2">
        <div className="w-4 h-4 bg-gray-200 rounded" />
        <div className="w-16 h-3 bg-gray-200 rounded" />
      </div>
      <div className="w-12 h-7 bg-gray-200 rounded mt-1" />
    </div>
  );
}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 space-y-6">
        <div className="bg-white rounded-xl border border-gray-200 shadow-sm p-6 animate-pulse">
          <div className="flex items-center justify-between mb-6">
            <div>
              <div className="w-40 h-7 bg-gray-200 rounded mb-2" />
        ...
        <div>
          <div className="w-36 h-5 bg-gray-200 rounded mb-4 animate-pulse" />
...
export function WorkspaceSkeleton() {
  return (
    <div className="h-screen flex flex-col bg-gray-50">
      <div className="border-b border-gray-200 bg-white px-4 py-3 flex items-center gap-4 shrink-0 animate-pulse">
      ...
      <div className="flex-1 flex min-h-0">
        <div className="w-[35%] border-r border-gray-200 bg-white p-4 animate-pulse">
        ...
        <div className="flex-1 p-4 animate-pulse">
          ...
          <div className="space-y-2">
            {Array.from({ length: 3 }).map((_, i) => (
              <div key={i} className="bg-white border border-gray-200 rounded-xl p-4 h-16" />
            ))}
          </div>
        </div>
      </div>
