...
const RELEASE_BASE = "https://github.com/karimmoh1-glitch/internops-refined/releases/download/companion-v1.0.0";
    ...
    <div className="min-h-screen bg-background text-white">
      <div className="max-w-2xl mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-10">
          <a
            href={`${RELEASE_BASE}/InternOps.Companion-1.0.0-arm64.dmg`}
          ...
          <a
            href={`${RELEASE_BASE}/InternOps.Companion-1.0.0.dmg`}
