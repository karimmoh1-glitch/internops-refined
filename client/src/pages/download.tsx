...
const RELEASE_BASE = "https://github.com/karimmoh1-glitch/internops-refined/releases/download/companion-v1.1.0";
    ...
    <div className="min-h-screen bg-background text-white">
      <div className="max-w-2xl mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-10">
          <a
            href={`${RELEASE_BASE}/InternOps.Companion-1.1.0-arm64.dmg`}
          ...
          <a
            href={`${RELEASE_BASE}/InternOps.Companion-1.1.0.dmg`}
          ...
          <a
            href={`${RELEASE_BASE}/InternOps.Companion-1.1.0-win.zip`}
            className="bg-card border border-white/[0.08] hover:border-white/20 transition-colors rounded-xl p-5 flex items-center gap-3"
